    ...
    public partial class ClothPane : UserControl
    {
        ...
        private void LoadFile()
        {
            ...
            foreach (var mesh in root.Meshes)
            {
                ...
                else
                {
                    ...
                    {
                        targetItems[targetItems.Count - 1].Checked = true;
                    }
                }
            }
        ...
        private void Generate()
        {
            ...
            foreach (int index in targetMeshesListView.CheckedIndices)
            {
                ...
                (short A, short B, short C)[] items = ClothUtils.Generate(physicsMesh, targetMesh);
        ...
        private static XElement CreateElement(string targetName, (short A, short B, short C)[] data)
        {
            /*
             * <node id="MapValue">
             *   <children>
